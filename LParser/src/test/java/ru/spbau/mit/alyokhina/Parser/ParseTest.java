...
public class ParseTest {
    ...
    public void test11() throws Exception {
        String data = readUsingFiles("src/main/resources/test11/test11.L");
        LexicalAnalyser lexicalAnalyser = new LexicalAnalyser(data);
        ArrayList<Token> tokens= lexicalAnalyser.getTokens();
        ArrayList<Node> trees = Parse.parse(tokens);
        FileWriter fileWriter = new FileWriter("src/main/resources/test11/test11.out", false);
        for (Node tree:trees) {
            tree.print(fileWriter);
        }

        assertEquals(readUsingFiles("src/main/resources/test11/rightAnswerForTest11"), readUsingFiles("src/main/resources/test11/test11.out"));
    }
